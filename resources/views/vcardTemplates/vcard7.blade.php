        ...
        <div class="main-bg p-0 collapse show allSection">
                                    ...
                                    <div class="card shadow-testi w-100 border-0 p-sm-4 p-3">
                                        <div class="card-body p-0">
                                            <div class="d-flex align-items-center testimonial-box">
                                                ...
                                                <div class="my-2">
                                                    <p class="mb-0 description-testi text-sm-start {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : ''}}">{!! $testimonial->description !!}</p>
                                                    <span
            ...
            @if(!empty($userSetting['enable_affiliation']))
                <div class='d-sm-flex justify-content-center mt-sm-2 pb-5'>
                    <button type="button" class="vcard-seven-btn copy-referral-btn d-block btn"
                            data-id="{{ $vcard->user->affiliate_code }}">
	                    <a class="text-dark text-decoration-none">
		                    <i class=" fa-regular fa-copy me-2"></i>{{ __('messages.vcard.copy_referral_link') }}</a>
                    </button>
                </div>
            @endif
