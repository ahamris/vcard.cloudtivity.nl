                ...
                @if($vcard->alternative_phone)
                    <div class="event-details d-flex">
                        ...
                        <span><a href="tel:+{{ $vcard->alternative_region_code }} {{ $vcard->alternative_phone }}"
                                 class="event-name text-center pt-3 mb-0 email-btn text-decoration-none">+{{ $vcard->alternative_region_code }}-{{ $vcard->alternative_phone }}</a></span>
                    </div>
                @endif
                @if($vcard->location)
                    <div class="event-details d-flex">
                        ...
                        @foreach($vcard->testimonials as $testimonial)
                            <div class="col-12 p-2">
                                <div class="card testimonial-card flex-sm-row flex-column-reverse p-3 border-0 align-items-center w-100">
                                    <div class="me-sm-3">
                                        <p class="review-message mb-2 text-sm-start text-center {{ \Illuminate\Support\Str::length($testimonial->description) > 100 ? 'more' : ''}}">
